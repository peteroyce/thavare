...
export default function RegisterPage() {
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4 py-20">
      <h1 className="font-serif text-[36px] font-medium text-navy mb-4">Create Account</h1>
      <p className="text-[15px] text-text-2 mb-8 text-center max-w-md">
        Account registration is coming soon. In the meantime, you can continue shopping as a guest.
      </p>
