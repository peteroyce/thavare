...
export function WelcomeBanner() {
  ...
  return (
    <div className="w-full bg-teal text-white py-2.5 px-4 flex items-center justify-center gap-3">
      ...
      <button
        ...
        className="ml-auto shrink-0 text-white/70 hover:text-white text-[16px] leading-none cursor-none transition-colors"
      >
        ×
      </button>
    </div>
