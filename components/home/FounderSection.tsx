      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 items-center">
        <AnimatedSection direction="left">
          <div className="rounded-2xl overflow-hidden border border-white/5 shadow-[0_32px_80px_rgba(0,0,0,0.4)] relative group md:hover:scale-[1.02] transition-transform duration-300">
            <div className="absolute font-serif text-[110px] leading-none text-terracotta/12 top-[-20px] left-2.5 z-10 pointer-events-none">"</div>
            <Image
            ...
            />
            <div className="px-7 py-6" style={{ background: 'linear-gradient(to top, #2C1810, rgba(44,24,16,0.85))' }}>
        ...
        <AnimatedSection direction="right">
          <div className="text-[10px] font-medium tracking-[4px] uppercase text-terracotta mb-3">The Founder's Story</div>
          ...
          <blockquote className="font-serif text-[17px] italic leading-[1.65] text-beige border-l-2 border-terracotta pl-6 mb-6">
