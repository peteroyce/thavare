...
const VALUES = [
  { icon: '🌱', title: 'Bio-Active Ayurveda',    desc: 'We take time-tested Ayurvedic ingredients and extract their highest-performing actives using modern biotechnology. No fillers. No compromise.' },
  { icon: '🔬', title: 'Clinically Formulated',  desc: 'Every Thavare formula is developed by Dr. Meena Ramaiah — dermatologist, Ayurvedic practitioner, athlete. Science and nature, carefully and honestly.' },
  { icon: '🏃', title: 'Built for Motion',       desc: 'Active skin faces sweat, sun, friction and wear. Thavare is the only Ayurvedic skincare range specifically engineered for the body in motion.' },
];
