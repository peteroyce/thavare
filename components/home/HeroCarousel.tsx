...
const SLIDES: Slide[] = [
  {
    ...
    ctas: [
      ...
      { text: 'Our Story', href: '/about', variant: 'dark' },
    ],
    image: null,
    darkText: true,
  },
  ...
  {
    id: 4,
    bg: 'linear-gradient(to right, rgba(217,196,169,0.78) 0%, rgba(217,196,169,0.38) 50%, rgba(200,180,145,0.08) 100%), url("/images/brand-slide-warm.png") right center / cover no-repeat',
