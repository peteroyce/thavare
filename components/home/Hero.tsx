...
export function Hero() {
  ...
  return (
    <section
      className="min-h-[92vh] bg-navy-deep grid grid-cols-2 items-center px-20 gap-16 relative overflow-hidden"
    ...
    >
      ...
      <div ref={contentRef} className="relative z-10">
        ...
        <div className="hero-entry flex gap-10 mt-12 pt-7 border-t border-white/10" style={{ animationDelay: '0.9s' }}>
